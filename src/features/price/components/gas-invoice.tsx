		...
		<Document>
			<Page size="A3" style={styles.page}>
				<View style={styles.section}>
					...
					<Text style={{ paddingLeft: 20, flexWrap: "wrap" }}>
						<Text style={{ fontWeight: "bold" }}>e.</Text>
						<Text style={{ fontWeight: "bold", marginLeft: 10 }}>
							{"   "} Precio promedio a {period} meses:{" "}
						</Text>
						Índice {index} diario. Precio fijo durante la vigencia del contrato.
					</Text>
					...
					<View style={styles.table}>
						<View style={styles.table_header}>
							<Text style={styles.table_header_row}>Mes</Text>
							<Text style={styles.table_header_row}>
								Fecha de precio forward
							</Text>
					...
					<View style={{ textAlign: "center" }}>
						<Text style={{ marginBottom: 13 }}>Atentamente,</Text>
